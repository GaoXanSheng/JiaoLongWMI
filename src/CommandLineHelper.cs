...
namespace JiaoLongWMI
{
    ...
    public static class CommandLineHelper
    {
        ...
        public static void ShowUsage()
        {
            ...
            Console.WriteLine("      示例：JiaoLongWMI CPU GetCustomMode  --parameter on");
            ...
            Console.WriteLine("      示例：JiaoLongWMI Fan GetFanSpeed --parameter on");
            ...
            Console.WriteLine("      示例：JiaoLongWMI Fan GetMaxFanSpeedSwitch --parameter on");
            Console.WriteLine();
            ...
            Console.WriteLine("      示例：JiaoLongWMI Keyboard ColorGet --parameter on");
            ...
            Console.WriteLine("      示例：JiaoLongWMI Keyboard ModeGet --parameter on");
            Console.WriteLine("    LightBrightnessGet: 获取当前键盘亮度，无参数");
            Console.WriteLine("      示例：JiaoLongWMI Keyboard LightBrightnessGet --parameter on");
            ...
            Console.WriteLine("      示例：JiaoLongWMI LogoLight Get --parameter on");
            Console.WriteLine();
